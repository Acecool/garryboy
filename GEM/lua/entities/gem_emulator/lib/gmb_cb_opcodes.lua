...
function mt:RotateLeftCarry(R1)
	local Bit7 = R1&128 == 128
	
	R1 = ((R1<<1) & 0xFE) | (Bit7 and 1 or 0)
...
function mt:RotateRightCarry(R1)
	...
	R1 = ((R1>>1) & 0xFF) | (Bit0 and 128 or 0)
...
function mt:RotateLeft(R1)
	...
	R1 = ((R1<<1) & 0xFE) | (self.Cf and 1 or 0)
...
function mt:RotateRight(R1)
	...
	R1 = ((R1>>1) & 0xFF) | (self.Cf and 128 or 0)
...
function mt:ArithmaticShiftLeft(R1)
	...
	R1 = (R1<<1) & 0xFE --- 0xFE for a reason, this is arithmatic shift.
...
function mt:ArithmaticShiftRight(R1)
	...
	R1 = ((R1>>1) & 0xFF ) | (Bit7 and 128 or 0)
...
OperatorsCB[ 0x06 ] = function( self ) self:Write((self.H<<8)|self.L, self:RotateLeftCarry( self:Read((self.H<<8)|self.L) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x0E ] = function( self ) self:Write((self.H<<8)|self.L, self:RotateRightCarry( self:Read((self.H<<8)|self.L) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x16 ] = function( self ) self:Write((self.H<<8)|self.L, self:RotateLeft( self:Read((self.H<<8)|self.L) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x1E ] = function( self ) self:Write((self.H<<8)|self.L, self:RotateRight( self:Read((self.H<<8)|self.L) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x26 ] = function( self ) self:Write((self.H<<8)|self.L, self:ArithmaticShiftLeft( self:Read((self.H<<8)|self.L) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x2E ] = function( self ) self:Write((self.H<<8)|self.L, self:ArithmaticShiftRight( self:Read((self.H<<8)|self.L) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x36 ] = function( self ) self:Write((self.H<<8)|self.L, self:Swap( self:Read((self.H<<8)|self.L) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x3E ] = function( self ) self:Write((self.H<<8)|self.L, self:ShiftRight( self:Read((self.H<<8)|self.L) ) ); self.Cycle = 16 end
...
OperatorsCB[ 0x46 ] = function( self ) self:TstBit( self:Read((self.H<<8)|self.L) ,0 ); self.Cycle = 16 end
...
OperatorsCB[ 0x4E ] = function( self ) self:TstBit( self:Read((self.H<<8)|self.L) ,1 ); self.Cycle = 16 end
...
OperatorsCB[ 0x56 ] = function( self ) self:TstBit( self:Read((self.H<<8)|self.L) ,2 ); self.Cycle = 16 end
...
OperatorsCB[ 0x5E ] = function( self ) self:TstBit( self:Read((self.H<<8)|self.L) ,3 ); self.Cycle = 16 end
...
OperatorsCB[ 0x66 ] = function( self ) self:TstBit( self:Read((self.H<<8)|self.L) ,4 ); self.Cycle = 16 end
...
OperatorsCB[ 0x6E ] = function( self ) self:TstBit( self:Read((self.H<<8)|self.L) ,5 ); self.Cycle = 16 end
...
OperatorsCB[ 0x76 ] = function( self ) self:TstBit( self:Read((self.H<<8)|self.L) ,6 ); self.Cycle = 16 end
...
OperatorsCB[ 0x7E ] = function( self ) self:TstBit( self:Read((self.H<<8)|self.L) ,7 ); self.Cycle = 16 end
...
OperatorsCB[ 0x86 ] = function( self ) self:Write((self.H<<8)|self.L, self:RstBit( self:Read((self.H<<8)|self.L)  ,0 )); self.Cycle = 16 end
...
OperatorsCB[ 0x8E ] = function( self ) self:Write((self.H<<8)|self.L, self:RstBit( self:Read((self.H<<8)|self.L) ,1 )); self.Cycle = 16 end
...
OperatorsCB[ 0x96 ] = function( self ) self:Write((self.H<<8)|self.L, self:RstBit( self:Read((self.H<<8)|self.L) ,2 )); self.Cycle = 16 end
...
OperatorsCB[ 0x9E ] = function( self ) self:Write((self.H<<8)|self.L, self:RstBit( self:Read((self.H<<8)|self.L) ,3 )); self.Cycle = 16 end
...
OperatorsCB[ 0xA6 ] = function( self ) self:Write((self.H<<8)|self.L, self:RstBit( self:Read((self.H<<8)|self.L) ,4 )); self.Cycle = 16 end
...
OperatorsCB[ 0xAE ] = function( self ) self:Write((self.H<<8)|self.L, self:RstBit( self:Read((self.H<<8)|self.L) ,5 )); self.Cycle = 16 end
...
OperatorsCB[ 0xB6 ] = function( self ) self:Write((self.H<<8)|self.L, self:RstBit( self:Read((self.H<<8)|self.L) ,6 )); self.Cycle = 16 end
...
OperatorsCB[ 0xBE ] = function( self ) self:Write((self.H<<8)|self.L, self:RstBit( self:Read((self.H<<8)|self.L) ,7 )); self.Cycle = 16 end
...
OperatorsCB[ 0xC6 ] = function( self ) self:Write((self.H<<8)|self.L, self:SetBit( self:Read((self.H<<8)|self.L) ,0 )); self.Cycle = 16 end
...
OperatorsCB[ 0xCE ] = function( self ) self:Write((self.H<<8)|self.L, self:SetBit( self:Read((self.H<<8)|self.L) ,1 )); self.Cycle = 16 end
...
OperatorsCB[ 0xD6 ] = function( self ) self:Write((self.H<<8)|self.L, self:SetBit( self:Read((self.H<<8)|self.L) ,2 )); self.Cycle = 16 end
...
OperatorsCB[ 0xDE ] = function( self ) self:Write((self.H<<8)|self.L, self:SetBit( self:Read((self.H<<8)|self.L) ,3 )); self.Cycle = 16 end
...
OperatorsCB[ 0xE6 ] = function( self ) self:Write((self.H<<8)|self.L, self:SetBit( self:Read((self.H<<8)|self.L) ,4 )); self.Cycle = 16 end
...
OperatorsCB[ 0xEE ] = function( self ) self:Write((self.H<<8)|self.L, self:SetBit( self:Read((self.H<<8)|self.L) ,5 )); self.Cycle = 16 end
...
OperatorsCB[ 0xF6 ] = function( self ) self:Write((self.H<<8)|self.L, self:SetBit( self:Read((self.H<<8)|self.L) ,6 )); self.Cycle = 16 end
...
OperatorsCB[ 0xFE ] = function( self ) self:Write((self.H<<8)|self.L, self:SetBit( self:Read((self.H<<8)|self.L) ,7 )); self.Cycle = 16 end
